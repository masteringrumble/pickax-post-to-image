...
>    and the image saves to your device. A floating Buy Me a Coffee button
>    (matching the site's blue widget) sits at the bottom-right while the
>    panel is open. Press Esc to leave picker mode. The website never opens.
